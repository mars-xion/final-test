...
export const dutchDesignWeekData = {
  ...
  sections: [
    ...
    },
    {
      title: "Reflection",
      description:
        "The event was a fun and enlightening experience, offering insights into different innovations and the chance to collaborate with international peers. It was a cultural exchange and creative inspiration from DDW exhibits.",
      image: "",
    },
  ],
  eventDetails: {
